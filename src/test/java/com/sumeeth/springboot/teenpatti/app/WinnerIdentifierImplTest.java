...
import static com.sumeeth.springboot.teenpatti.Entity.Winner.WIN_TYPE.SAME_COLOR_HIGHER_WEIGHTAGE;
...
public class WinnerIdentifierImplTest extends TestCase {
    ...
    public void testfindWinner() {
        ...
        assertEquals("Wintype should be " + SAME_COLOR_HIGHER_WEIGHTAGE, SAME_COLOR_HIGHER_WEIGHTAGE, winner.get().getWinType());
        assertEquals("Winner should be Sumeeth.", "Sumeeth",
    ...
    private void distributeCards() {
        ...
        cardList2.add(new Card(7, Card.COLOR.RED, Card.TYPE.DIAMOND));
